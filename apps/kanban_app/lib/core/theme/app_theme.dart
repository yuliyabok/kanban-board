//в этом файле описана вся тема приложения, включая цвета, шрифты, отступы, радиусы и т.д.
// Это позволяет централизованно управлять стилем приложения и легко переключаться между светлой и темной темой.
