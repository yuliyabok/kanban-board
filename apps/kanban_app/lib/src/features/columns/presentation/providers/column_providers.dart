// Провайдеры колонок Kanban-доски. В local-режиме remote-слой имитируется,
// в server-режиме используется API datasource.
...
final columnRemoteDataSourceProvider = Provider<ColumnRemoteDataSource>((ref) {
  ...
  if (config.usesServerRemote) {
    return ApiColumnRemoteDataSource(ref.watch(apiClientProvider));
  }
