// Провайдеры типов задач. Они подключают offline-first repository и выбирают
// local или API remote datasource через глобальный config.
...
final taskTypeRemoteDataSourceProvider = Provider<TaskTypeRemoteDataSource>((
  ...
  if (config.usesServerRemote) {
    return ApiTaskTypeRemoteDataSource(ref.watch(apiClientProvider));
  }
