...
class _BoardColumnViewState extends State<BoardColumnView> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = AppBoardBackgroundPalette.resolveColumn(
      context,
      widget.settings.columnBackgroundColor,
    );
    ...
    final resolvedWidth =
        widget.width ?? defaultWidth.clamp(280, 360).toDouble();

    return DragTarget<TaskEntity>(
      onWillAcceptWithDetails: (details) => true,
      onAcceptWithDetails: (details) => widget.onMoveTaskHere(details.data),
              ...
              Expanded(
                child: widget.tasks.isEmpty
                    ...
                    : Scrollbar(
                        ...
                        thumbVisibility: AppBreakpoints.of(context).isDesktop,
                        child: ListView.builder(
                          controller: _scrollController,
                          padding: EdgeInsets.all(context.spacing.sm),
                          itemCount: widget.tasks.length,
                          itemBuilder: (context, index) {
                            final viewModel = widget.tasks[index];
                            ...
                            final card = Padding(
                              ...
                              child: TaskCard(
                                ...
                                onOpen: () => widget.onOpenTask(viewModel),
