...
import '../../data/datasources/task_assignee_remote_datasource.dart';
...
final taskAssigneeRemoteDataSourceProvider =
    Provider<TaskAssigneeRemoteDataSource>((ref) {
      final config = ref.watch(appConfigProvider);
      if (config.usesServerRemote) {
        return ApiTaskAssigneeRemoteDataSource(ref.watch(apiClientProvider));
      }
      return const MockTaskAssigneeRemoteDataSource();
    });
...
final taskAssigneeRepositoryProvider = Provider<TaskAssigneeRepository>(
  (ref) => DefaultTaskAssigneeRepository(
    ...
    remoteDataSource: ref.watch(taskAssigneeRemoteDataSourceProvider),
