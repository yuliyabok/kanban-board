...
import '../../features/gantt/presentation/pages/gantt_page.dart';
...
import '../../features/whats_new/presentation/pages/whats_new_page.dart';
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        name: AppRoute.whatsNew.name,
        builder: (context, state) => const WhatsNewPage(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: AppRoute.gantt.path,
        name: AppRoute.gantt.name,
        builder: (context, state) => const GanttPage(),
      ),
      GoRoute(
