...
mixin _$TaskEntity {
 ...
 String get id; String get boardId; String get title; int get position; DateTime get createdAt; DateTime get updatedAt; String? get columnId; String? get parentTaskId; String? get taskTypeId; String? get description; String? get cardBackgroundColor; String? get cardTextColor; int get depth; TaskStatus get status; TaskPriority get priority; String? get assigneeName; List<String> get labels; DateTime? get startDate; DateTime? get dueDate; DateTime? get completedAt; int? get estimatedDurationMinutes; int? get actualDurationMinutes; TaskPeriodType get periodType; bool get isCompleted; DateTime? get deletedAt; bool get isSynced;
...
@useResult
$Res call({
 String id, String boardId, String title, int position, DateTime createdAt, DateTime updatedAt, String? columnId, String? parentTaskId, String? taskTypeId, String? description, String? cardBackgroundColor, String? cardTextColor, int depth, TaskStatus status, TaskPriority priority, String? assigneeName, List<String> labels, DateTime? startDate, DateTime? dueDate, DateTime? completedAt, int? estimatedDurationMinutes, int? actualDurationMinutes, TaskPeriodType periodType, bool isCompleted, DateTime? deletedAt, bool isSynced
});
...
as TaskPriority,assigneeName: freezed == assigneeName ? _self.assigneeName : assigneeName // ignore: cast_nullable_to_non_nullable
...
as TaskPeriodType,isCompleted: null == isCompleted ? _self.isCompleted : isCompleted // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String boardId,  String title,  int position,  DateTime createdAt,  DateTime updatedAt,  String? columnId,  String? parentTaskId,  String? taskTypeId,  String? description,  String? cardBackgroundColor,  String? cardTextColor,  int depth,  TaskStatus status,  TaskPriority priority,  String? assigneeName,  List<String> labels,  DateTime? startDate,  DateTime? dueDate,  DateTime? completedAt,  int? estimatedDurationMinutes,  int? actualDurationMinutes,  TaskPeriodType periodType,  bool isCompleted,  DateTime? deletedAt,  bool isSynced)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskEntity() when $default != null:
return $default(_that.id,_that.boardId,_that.title,_that.position,_that.createdAt,_that.updatedAt,_that.columnId,_that.parentTaskId,_that.taskTypeId,_that.description,_that.cardBackgroundColor,_that.cardTextColor,_that.depth,_that.status,_that.priority,_that.assigneeName,_that.labels,_that.startDate,_that.dueDate,_that.completedAt,_that.estimatedDurationMinutes,_that.actualDurationMinutes,_that.periodType,_that.isCompleted,_that.deletedAt,_that.isSynced);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String boardId,  String title,  int position,  DateTime createdAt,  DateTime updatedAt,  String? columnId,  String? parentTaskId,  String? taskTypeId,  String? description,  String? cardBackgroundColor,  String? cardTextColor,  int depth,  TaskStatus status,  TaskPriority priority,  String? assigneeName,  List<String> labels,  DateTime? startDate,  DateTime? dueDate,  DateTime? completedAt,  int? estimatedDurationMinutes,  int? actualDurationMinutes,  TaskPeriodType periodType,  bool isCompleted,  DateTime? deletedAt,  bool isSynced)  $default,) {final _that = this;
switch (_that) {
case _TaskEntity():
return $default(_that.id,_that.boardId,_that.title,_that.position,_that.createdAt,_that.updatedAt,_that.columnId,_that.parentTaskId,_that.taskTypeId,_that.description,_that.cardBackgroundColor,_that.cardTextColor,_that.depth,_that.status,_that.priority,_that.assigneeName,_that.labels,_that.startDate,_that.dueDate,_that.completedAt,_that.estimatedDurationMinutes,_that.actualDurationMinutes,_that.periodType,_that.isCompleted,_that.deletedAt,_that.isSynced);case _:
  throw StateError('Unexpected subclass');
...
class _TaskEntity implements TaskEntity {
  const _TaskEntity({required this.id, required this.boardId, required this.title, required this.position, required this.createdAt, required this.updatedAt, this.columnId, this.parentTaskId, this.taskTypeId, this.description, this.cardBackgroundColor, this.cardTextColor, this.depth = 0, this.status = TaskStatus.todo, this.priority = TaskPriority.medium, this.assigneeName, final  List<String> labels = const [], this.startDate, this.dueDate, this.completedAt, this.estimatedDurationMinutes, this.actualDurationMinutes, this.periodType = TaskPeriodType.custom, this.isCompleted = false, this.deletedAt, this.isSynced = false}): _labels = labels;
...
@override@JsonKey() final  TaskPeriodType periodType;
